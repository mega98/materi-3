...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            style="background:url(public/images/image_6.jpg) no-repeat center center;">
            <div class="auth-box row text-center">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(public/images/bg_3.jpg);">
                </div>
                        ...
                        <form class="mt-4">
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="submit" class="btn btn-block btn-dark"><a href="index">Sign Up</a></button>
                                </div>
                                <div class="col-lg-12 text-center mt-5">
                                    Already have an account? <a href="#" class="text-danger"><a href="login">Sign In</a></a>
                                </div>
                            </div>
                        </form>
                    </div>
